...
class SplashController extends GetxController with GetTickerProviderStateMixin {
  ...
  fadeInAnimation() {
    controller = Rx(AnimationController(
        duration: const Duration(milliseconds: 1800), vsync: this));
    animation =
        Rx(CurvedAnimation(parent: controller!.value, curve: Curves.easeIn));
    Future.delayed(
        const Duration(milliseconds: 400), () => controller!.value.forward());
  }
